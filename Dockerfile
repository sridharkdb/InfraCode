...
# --------------------------
# This is the Dockerfile for Mediawiki latest on Oracle Linux 8.9
# REQUIRED FILES TO BUILD THIS IMAGE
# ----------------------------------
# (1) Install MediaWiki tarball ("sources")
# (2) this is only mediawiki webapp and database mariadb packages(mariadb-server,mariadb) will be created separately   
